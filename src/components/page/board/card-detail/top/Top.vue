<template>
    <div class="card-detail-top">
        <div :class="['card-detail-top__compleet', card.ready ? 'active' : '']">
            <button v-if="!card.isArchive" @click="compleet">
...
<script>
    export default {
        ...
        methods: {
            compleet() {
                this.updateParam(!this.card.ready, 'ready');
            ...
            restore() {
                this.$store.commit('restoreCard', this.card);
            },
            remove() {
                this.$store.commit('removeFromArchive', this.card);
            },
            toArchive() {
